...
index = pinecone.Index('pdfbot',"host=https://pdfbot-n10unc5.svc.aped-4627-b74a.pinecone.io")
...
# Sidebar menu
with st.sidebar:
    selected_page = option_menu("Main Menu", ['Upload Document', 'Question Answers'], icons=['cloud-upload', 'question', 'list-task'])

# Display content based on the selected page
if selected_page:
    if selected_page == 'Upload Document':
        st.title("Welcome to Document Uploader")
        st.subheader("Please upload a transcript.")
